                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6" id="intro-card">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                I was built using laravel, websockets, Pusher and a bit of vanilla js. My job is to
                    ...
                    <div id="message-card"
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="#" id="topic"
                                    class=" text-gray-900 dark:text-white">Topic appears here</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm" id="message">
                                Message comes down here
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    // Recieve the message from the server and call the alert.
    Echo.private('App.Models.User.1')
        .notification((notification) => {
            ...
            Swal.fire({
                ...
                .then(function() {
                    passMessage(notification) // Render the message
                })

        });

    // render message method
    passMessage = (notification) => {
        document.getElementById("topic").innerHTML = notification.message.topic;
        document.getElementById("message").innerHTML = notification.message.message;
    }

</script>


<?php /**PATH C:\Users\hp\Desktop\work\upgrade\Pangaea-publishing-server\subscribing-server-01\resources\views/welcome.blade.php ENDPATH**/ ?>